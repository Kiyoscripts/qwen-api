...
// chat vision and image-to-video take exactly one. Speech takes none.
          ...
          <section className="pgx-sec">
            ...
            {mode === "video" && (
              <>
                ...
                <p className="pgx-note">Attach an image in the composer for image-to-video. Renders have no time limit.</p>
              </>
            )}
