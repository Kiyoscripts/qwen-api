-- HISTORICAL MIRROR ONLY. Do not execute this file.
-- The authoritative schema starts at migrations/001_initial_schema.sql and is
-- applied exclusively through `npm run db:migrate`.
-- Qwen3.8 API - PostgreSQL schema
